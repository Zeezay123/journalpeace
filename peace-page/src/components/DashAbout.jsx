...
export default function SiteSettingsAdmin() {
  ...
  const [homeImageUploadProg, setHomeImageUploadProg] = useState('')
...
const handleUploadhomeImage =async () => {
 if (!homeImageFile) return;
    const url = await uploadImage(homeImageFile, setHomeImageUploadProg);
    if (url) setFormData((prev) => ({ ...prev, homeimage: url }));
}
...
const handleHomeImageChange = (e) =>{
 ...
 <div className="flex flex-col gap-5 justify-center items-center">
              <div className="flex flex-col gap-3 w-full max-w-md">
                <Label className="mb-1">Hero Image</Label>
                <FileInput
                  id="homeimage"
                  name="homeimage"
                  accept="image/*"
                ...
                <Button
                  ...
                  size="sm"
                  outline
                  onClick={handleUploadhomeImage}
                  disabled={homeImageUploadProg}
                >
                  { homeImageUploadProg ? <div className='w-16 h-16'> 
                 
               <CircularProgressbar value={homeImageUploadProg} text={`${homeImageUploadProg || 0 }%`}/>
